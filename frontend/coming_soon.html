			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					<div id="logo" class="divcenter">
						<a href="index.html" class="standard-logo" data-dark-logo="<?php echo base_url() ?>assets/images/logo-dark.png"><img class="divcenter" src="<?php echo base_url() ?>assets/images/logo.png" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="<?php echo base_url() ?>assets/images/logo-dark@2x.png"><img class="divcenter" src="<?php echo base_url() ?>assets/images/logo@2x.png" alt="Canvas Logo"></a>
				</div><!-- #logo end -->
